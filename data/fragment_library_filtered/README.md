...
In order to prepare a library with fragments tailored for recombination, we offer here a filtered fragment library (3414 fragments) based on the following filters:
