...
Note that results in all notebooks may differ from the numbers shown in the publication because of new data added to ChEMBL (current version: ChEMBL 36) and KLIFS (current version from 06.12.2023), and updates on KinFragLib.
</div>
